...
function CreateTask() {
 ...
 return (
  <div className="max-w-6xl mx-auto p-4 md:p-8 animate-in fade-in duration-500">
    <button className='btn btn-ghost btn-sm hover:bg-base-300 gap-2 mb-4 border border-white' onClick={() => navigate(-1)}>
        <MoveLeft/> Go back
      </button>
    {/* Header */}
    <div className="mb-8">
      ...
      <p className="text-base-content/60 text-sm mt-1">Organize your day and boost your productivity.</p>
    </div>
